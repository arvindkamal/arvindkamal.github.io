var Zepto = (function () {
  ...
  return (
    ...
    (Q.fragment = function (t, e, n) {
      var r, i, a;
      return (
        Z.test(t) && (r = j(A.createElement(RegExp.$1))),
        r ||
          (t.replace && (t = t.replace(H, "<$1></$2>")),
          e === w && (e = I.test(t) && RegExp.$1),
          e in z || (e = "*"),
          (a = z[e]),
          (a.innerHTML = "" + t),
          (r = j.each(N.call(a.childNodes), function () {
            a.removeChild(this);
          }))),
        o(n) &&
          ((i = j(r)),
    ...
    (Q.init = function (t, n) {
      ...
      if (!t) return Q.Z();
      if ("string" == typeof t)
        if (((t = t.trim()), "<" == t[0] && I.test(t)))
          (r = Q.fragment(t, RegExp.$1, n)), (t = null);
        else {
        ...
        if (W(t)) r = s(t);
          ...
          (r = Q.fragment(t.trim(), RegExp.$1, n)), (t = null);
        else {
          if (n !== w) return j(n).find(t);
          r = Q.qsa(A, t);
        }
      ...
      parents: function (t) {
        for (var e = [], n = this; n.length > 0; )
          n = j.map(n, function (t) {
            return (t = t.parentNode) && !r(t) && e.indexOf(t) < 0
              ? (e.push(t), t)
              : void 0;
          });
        return m(e, t);
      ...
      position: function () {
        if (this.length) {
          var t = this[0],
            e = this.offsetParent(),
            n = this.offset(),
            r = _.test(e[0].nodeName) ? { top: 0, left: 0 } : e.offset();
          return (
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            t && !_.test(t.nodeName) && "static" == j(t).css("position");
      ...
      (j.fn[e] = function () {
        var e,
          ...
          o = j.map(arguments, function (n) {
            return (
              (e = t(n)),
              "object" == e || "array" == e || null == n ? n : Q.fragment(n)
            );
          }),
          a = this.length > 1;
        return o.length < 1
        ...
        (j.fn[r ? e + "To" : "insert" + (n ? "Before" : "After")] = function (
          t,
        ) {
...
(window.Zepto = Zepto),
  ...
  (function (t) {
        ...
        n(t, e, i, s).forEach(function (e) {
          delete v[u][e.i],
            "removeEventListener" in t &&
              t.removeEventListener(a(e.e), e.proxy, o(e, c));
        });
      });
    }
    function u(e, n) {
    ...
    (t.fn.delegate = function (t, e, n) {
      ...
      (t.fn.trigger = function (e, n) {
        return (
          (e = m(e) || t.isPlainObject(e) ? t.Event(e) : u(e)),
          (e._args = n),
          this.each(function () {
    ...
    (C.href = window.location.href),
      ...
      (t.ajax = function (e) {
        ...
        if (
          (d && (p = "jsonp"),
          (i.cache !== !1 &&
            ((e && e.cache === !0) || ("script" != p && "jsonp" != p))) ||
            (i.url = f(i.url, "_=" + Date.now())),
          "jsonp" == p)
        )
          return (
            d ||
              (i.url = f(
                i.url,
                i.jsonp ? i.jsonp + "=?" : i.jsonp === !1 ? "" : "callback=?",
              )),
            t.ajaxJSONP(i, c)
          );
        var g,
        ...
        if (
          ...
          (b = i.mimeType || b) &&
            ...
            j.overrideMimeType && j.overrideMimeType(b)),
          (i.contentType ||
            (i.contentType !== !1 &&
              i.data &&
          ...
          (j.onreadystatechange = function () {
            if (4 == j.readyState) {
              ...
              if (
                ...
                (p = p || l(i.mimeType || j.getResponseHeader("content-type"))),
                  (e = j.responseText);
                try {
                  "script" == p
                    ? (0, eval)(e)
                    : "xml" == p
                      ? (e = j.responseXML)
                      : "json" == p && (e = S.test(e) ? null : t.parseJSON(e));
                } catch (r) {
                  n = r;
                }
                n ? s(n, "parsererror", j, i, c) : a(e, j, i, c);
              } else
                s(j.statusText || null, j.status ? "error" : "abort", j, i, c);
            }
          }),
          o(j, i) === !1)
        )
          return j.abort(), s(null, "abort", j, i, c), j;
        if (i.xhrFields) for (v in i.xhrFields) j[v] = i.xhrFields[v];
        var T = !("async" in i) || i.async;
        j.open(i.type, i.url, T, i.username, i.password);
        for (v in x) O.apply(j, x[v]);
        return (
          i.timeout > 0 &&
            (g = setTimeout(function () {
              (j.onreadystatechange = u),
                j.abort(),
                s(null, "timeout", j, i, c);
            }, i.timeout)),
          j.send(i.data ? i.data : null),
          j
        );
      }),
      (t.get = function () {
  ...
  (function (t, e) {
    ...
    var e,
      ...
      s = function (t, e, n) {
        ...
        else for (var i = 0, o = t.length; i < o; i++) e.call(n, t[i], i, t);
      },
      c = function (t, e) {
        var n = {};
        return (
      ...
      p = function (t, e, n) {
        var r = 0;
        if (t.offsetParent)
          do (r += t.offsetTop), (t = t.offsetParent);
          while (t);
    ...
    i.animateScroll = function (e, n, i) {
      ...
      var O = function (r, i, a) {
          var s = t.pageYOffset;
          (r == i || s == i || t.innerHeight + s >= S) &&
            (clearInterval(a), u.focus(), o.callbackAfter(e, n));
        },
        T = function () {
          (C += 16),
            (b = C / parseInt(o.speed, 10)),
            (b = b > 1 ? 1 : b),
            (x = g + j * h(o.easing, b)),
    ...
    var g = function (t) {
        ...
        n &&
          ...
          (t.preventDefault(), i.animateScroll(n, n.hash, e));
      },
      y = function (t) {
        n ||
    ...
    return (
      (i.destroy = function () {
        e &&
          ...
          t.removeEventListener("resize", y, !1),
          (e = null),
          (n = null),
          (r = null));
      }),
      (i.init = function (n) {
        o &&
          (i.destroy(),
          (e = c(a, n || {})),
          (r = document.querySelector("[data-scroll-header]")),
          document.addEventListener("click", g, !1),
          r && t.addEventListener("resize", y, !1));
      }),
      i
    );
  }),
  (function (t) {
    t.fn.simpleJekyllSearch = function (e) {
        ...
        return (
          t.each(c, function (t, r) {
            for (var t = 0; t < s.length; t++)
              void 0 !== r[s[t]] &&
                r[s[t]].toLowerCase().indexOf(e.toLowerCase()) !== -1 &&
                (n.push(r), (t = s.length));
          }),
          n
        );
      ...
      function i(e) {
        o(),
          l.append(t(a.searchResultsTitle)),
          e.length
